...
#print(username)
username.send_keys("#major group instagram id")

#driver.close()

password=driver.find_element_by_name('password')

password.send_keys("#major group password")   
...
print(name.text)
try:
    for i in range(1,(int)((800+3-1)/3)):
        #print(df.head())
        jj=i
        print("row number ",i)
    ...
    df.to_csv('C:\\Users\\shash\\Desktop\\Data_Science\\Major2020\\webScrapping\\counts\\katrinakaif.csv',index=False)        
    driver.close() 